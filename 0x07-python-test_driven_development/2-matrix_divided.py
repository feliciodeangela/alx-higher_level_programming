...
def matrix_divided(matrix, div):
    """This function clones a matrix and returns a new one
       ...
       Returns:
           The resuling matrix after dividing all elements by `div` rounded by two decimal places.

       Raises:
           TypeError: If element of matrix is not int|float and all rows are not the same size,
